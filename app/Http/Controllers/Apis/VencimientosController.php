...
class VencimientosController extends Controller
{
    ...
    public function mostrarFechasSectorista($sectoristaId)
    {
        $fechaActual = date('Y-m-d');
        $documentosSectorista = documentos::select("documentos.fechavencimiento as documentosVencimiento")
                                        ->join('clientes as c', 'c.id', '=', 'documentos.cliente_id')
                                        ->join('sectores as sct', 'sct.id', '=', 'c.sector_id')
        ...
        if (sizeof($documentosSectorista) > 0){
            return json_encode(array("code" => true, "result"=>$documentosSectorista, "load"=>true));
        }else{
            return json_encode(array("code" => false, "load"=>true));
        }
    ...
    public function fechasDocumentosSectorista($sectoristaId)
    {//espera
